...
| Gemini request and inline image response | `core/api_client.py` | `gemini/*.json` | Implemented M2; pending slice review |
| Gemini blocked/error response | `core/api_client.py` | `gemini/generate-blocked.json` | Implemented M2; pending slice review |
| Gemini `BLOCK_NONE` behavior | `core/api_client.py` | Resolved M0 decision 10 | Implemented M2; pending slice review |
| GPT JSON generation | `core/gpt_client.py` | `openai/generation-success.json` | Implemented M2; pending slice review |
| GPT multipart edit with references | `core/gpt_client.py` | Same response contract as generation | Implemented M2; pending slice review |
| GPT provider error response | `core/gpt_client.py` | `openai/error.json` | Implemented M2; pending slice review |
...
| Strict TLS plus per-host compatibility mode | Desktop uses `verify=False`; Android decision differs | `docs/ANDROID-RELAY-TRANSPORT-SECURITY.md` | Implemented M2; pending slice review |
